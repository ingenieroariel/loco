...
class AerodromesPoint(models.Model):
    ...
    barrier = models.CharField(max_length=-1, blank=True, null=True)
    ...
    is_in = models.CharField(max_length=-1, blank=True, null=True)
    place = models.CharField(max_length=-1, blank=True, null=True)
    man_made = models.CharField(max_length=-1, blank=True, null=True)
...
class AerodromesPolygon(models.Model):
    ...
    wkb_geometry = models.TextField(blank=True, null=True)  # This field type is a guess.
    osm_id = models.CharField(max_length=-1, blank=True, null=True)
    osm_way_id = models.CharField(max_length=-1, blank=True, null=True)
    name = models.CharField(max_length=-1, blank=True, null=True)
    type = models.CharField(max_length=-1, blank=True, null=True)
    aeroway = models.CharField(max_length=-1, blank=True, null=True)
    amenity = models.CharField(max_length=-1, blank=True, null=True)
    admin_level = models.CharField(max_length=-1, blank=True, null=True)
    barrier = models.CharField(max_length=-1, blank=True, null=True)
    boundary = models.CharField(max_length=-1, blank=True, null=True)
    building = models.CharField(max_length=-1, blank=True, null=True)
    craft = models.CharField(max_length=-1, blank=True, null=True)
    geological = models.CharField(max_length=-1, blank=True, null=True)
    historic = models.CharField(max_length=-1, blank=True, null=True)
    land_area = models.CharField(max_length=-1, blank=True, null=True)
    landuse = models.CharField(max_length=-1, blank=True, null=True)
    leisure = models.CharField(max_length=-1, blank=True, null=True)
    man_made = models.CharField(max_length=-1, blank=True, null=True)
    military = models.CharField(max_length=-1, blank=True, null=True)
    natural = models.CharField(max_length=-1, blank=True, null=True)
    office = models.CharField(max_length=-1, blank=True, null=True)
    place = models.CharField(max_length=-1, blank=True, null=True)
    shop = models.CharField(max_length=-1, blank=True, null=True)
    sport = models.CharField(max_length=-1, blank=True, null=True)
    tourism = models.CharField(max_length=-1, blank=True, null=True)
    other_tags = models.TextField(blank=True, null=True)  # This field type is a guess.
...
class AllRoads(models.Model):
    ...
    name = models.CharField(max_length=-1, blank=True, null=True)
    highway = models.CharField(max_length=-1, blank=True, null=True)
    waterway = models.CharField(max_length=-1, blank=True, null=True)
    aerialway = models.CharField(max_length=-1, blank=True, null=True)
    barrier = models.CharField(max_length=-1, blank=True, null=True)
    man_made = models.CharField(max_length=-1, blank=True, null=True)
    other_tags = models.TextField(blank=True, null=True)  # This field type is a guess.
